...
log = logging.getLogger("waymark4.events")

OBSERVATION_CHANNEL = "waymark4_observations"
DERIVATION_CHANNEL = "waymark4_derivations"
...
class Dispatcher:
    ...
    async def start(self) -> None:
        ...
        self._task = asyncio.create_task(self._run(), name="waymark4-dispatcher")
