"""The waymark4 CLI: check | routes | openapi | migrate | new-resource
...
def migrate(engine_spec: str = typer.Argument(
        "app.main:engine", help="module:attr of the Engine"),
        directory: Path = typer.Option(Path("migrations/waymark4"),
...
from waymark4 import Acknowledged, Ctx, Resource, Safety, action
