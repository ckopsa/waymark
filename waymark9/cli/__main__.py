"""The waymark9 CLI: check | routes | openapi | migrate | new-resource
...
def migrate(engine_spec: str = typer.Argument(
        "app.main:engine", help="module:attr of the Engine"),
        directory: Path = typer.Option(Path("migrations/waymark9"),
...
from waymark9 import Acknowledged, Ctx, Resource, Safety, action
