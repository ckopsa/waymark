...
or an event class (design: docs/waymark9-design.md)."""
...
FORMAT_VERSION = "9"
MEDIA_TYPE = "application/waymark+json; v=9"
...
def __getattr__(name: str):
    ...
    # waymark9` stays light for definition-only consumers (e.g. the CLI check).
