...
log = logging.getLogger("waymark9.events")

OBSERVATION_CHANNEL = "waymark9_observations"
DERIVATION_CHANNEL = "waymark9_derivations"
...
class Dispatcher:
    ...
    async def start(self) -> None:
        ...
        self._task = asyncio.create_task(self._run(), name="waymark9-dispatcher")
