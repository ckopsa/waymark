...
DEPLOY = Principal(id="waymark9-deploy", type="system", display="Deploy")
...
log = logging.getLogger("waymark9.definitions")
...
class DefinitionData(BaseModel):
    ...
    # in an engine bookkeeping row (the ``waymark9_cursors`` precedent),
