...
(defn crown-rank-diff
  "The crown's five numbers, read side by side (waymark-1uv.2) —
  ...
  (let [a (crown-rank-of {:crown-rank was})
    ...
    (cond
      ...
      [(str "The crown's rank turns OFF: every one of its five numbers is 0,"
      ...
      (into []
            ...
            [(line :declared "In the crown, serving a value this house declared lifts a bundle")
             ...
             (line :early "In the crown, each day early a recomposition arrives — before the day the house said it would hear that line of thinking again — holds it")]))))
