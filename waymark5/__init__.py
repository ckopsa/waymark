...
or an event class (design: docs/waymark5-design.md)."""
...
FORMAT_VERSION = "5"
MEDIA_TYPE = "application/waymark+json; v=5"
...
__all__ = [
    ...
    "Deny", "Derived", "DraftPolicy", "Edit", "Effect", "Guard", "Never",
    "OneOf", "Owns",
...
def __getattr__(name: str):
    ...
    # waymark5` stays light for definition-only consumers (e.g. the CLI check).
