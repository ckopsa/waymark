...
log = logging.getLogger("waymark5.events")

OBSERVATION_CHANNEL = "waymark5_observations"
DERIVATION_CHANNEL = "waymark5_derivations"
...
class Dispatcher:
    ...
    async def start(self) -> None:
        ...
        self._task = asyncio.create_task(self._run(), name="waymark5-dispatcher")
