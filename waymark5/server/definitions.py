...
DEPLOY = Principal(id="waymark5-deploy", type="system", display="Deploy")
...
log = logging.getLogger("waymark5.definitions")
...
class DefinitionData(BaseModel):
    ...
    # in an engine bookkeeping row (the ``waymark5_cursors`` precedent),
