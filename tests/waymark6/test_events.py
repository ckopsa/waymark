"""waymark6 SSE endpoints end-to-end over a real uvicorn server (httpx's
...
async def env():
    ...
    engine = waymark6.Engine(resources=[Ticket], storage=TEST_DSN,
...
async def test_rate_windows_ride_the_bus():
    ...
    from waymark6.server.bus import InProcessBus, RateCoordinator
