...
import waymark6
from waymark6 import Ctx, Derived, Resource, Safety, action, filterable, sortable
...
@pytest.fixture
async def env():
    engine = waymark6.Engine(resources=[Task], storage=TEST_DSN,
