...
from tests.waymark6.mealplan6.meal import Meal, MealData
from tests.waymark6.mealplan6.plan import MealPlan
from tests.waymark6.mealplan6.prep_task import PrepTask
from tests.waymark6.mealplan6.rotation import SundayRotation
...
async def test_vocab_is_one_declaration():
    ...
    from waymark6.core.resource import FilterOp
...
async def test_placeholder_is_declared_on_the_wire():
    from tests.waymark6.mealplan6.plan import DayPlan
...
async def test_upcast_chain_must_be_contiguous():
    from waymark6 import DefinitionError, Resource
...
async def test_faceted_must_be_filterable():
    ...
    from waymark6.core.checks import DefinitionError
