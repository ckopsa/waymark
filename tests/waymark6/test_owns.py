...
import waymark6
from waymark6 import DefinitionError, Registry
from waymark6.core import checks
...
from tests.waymark6.mealplan6.grocery_list import GroceryList
...
async def test_check_owns_rejects_bad_declarations(env):
    ...
    from waymark6 import Owns, Rollup
