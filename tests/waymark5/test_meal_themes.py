...
from mealplan5.resources.meal import Meal, MealData
...
async def test_vocab_is_one_declaration():
    ...
    from waymark5.core.resource import FilterOp
...
async def test_placeholder_is_declared_on_the_wire():
    from mealplan5.resources.plan import DayPlan
...
async def test_upcast_chain_must_be_contiguous():
    from waymark5 import DefinitionError, Resource
...
async def test_faceted_must_be_filterable():
    ...
    from waymark5.core.checks import DefinitionError
