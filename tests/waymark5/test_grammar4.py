...
import waymark5
from waymark5 import Ctx, Derived, Resource, Safety, action, filterable, sortable
...
@pytest.fixture
async def env():
    engine = waymark5.Engine(resources=[Task], storage=TEST_DSN,
