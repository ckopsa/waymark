...
def _engine(resources):
    return waymark5.Engine(resources=resources, storage=TEST_DSN,
...
async def test_crashed_immediate_backfill_recovers_on_next_boot():
    ...
    try:
        ...
        assert settled.actor_id == "waymark5-deploy"
...
async def test_marker_for_removed_fact_is_dropped_with_a_log_line(caplog):
    ...
    caplog.set_level(logging.INFO, logger="waymark5.definitions")
