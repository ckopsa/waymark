"""waymark5 SSE endpoints end-to-end over a real uvicorn server (httpx's
...
async def env():
    ...
    engine = waymark5.Engine(resources=[Ticket], storage=TEST_DSN,
...
async def test_rate_windows_ride_the_bus():
    ...
    from waymark5.server.bus import InProcessBus, RateCoordinator
