"""The mealplan8 dogfood's driving story (design 6.0 §1–§2 appendix):
...
from mealplan8.event_source import FakeEvents
from mealplan8.resources.event import Event
from mealplan8.resources.grocery_list import GroceryList
from mealplan8.resources.meal import Meal
from mealplan8.resources.plan import MealPlan
from mealplan8.resources.prep_task import PrepTask
from mealplan8.resources.rotation import SundayRotation
from mealplan8.services import Services
...
async def test_sync_window_widens_to_cover_a_far_out_plan(env):
    ...
    from mealplan8.event_source import (
