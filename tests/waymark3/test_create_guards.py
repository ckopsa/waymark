...
from waymark3.core.guards import Guard
from waymark3.core.types import Acknowledged, Allow, DefinitionError, Deny
...
@pytest.fixture
async def env():
    engine = waymark3.Engine(resources=[ReconEvent], storage=TEST_DSN,
