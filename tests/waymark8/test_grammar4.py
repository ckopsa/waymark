...
import waymark8
from waymark8 import Ctx, Derived, Resource, Safety, action, filterable, sortable
...
@pytest.fixture
async def env():
    engine = waymark8.Engine(resources=[Task], storage=TEST_DSN,
