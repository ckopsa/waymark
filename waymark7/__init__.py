...
or an event class (design: docs/waymark7-design.md)."""
...
FORMAT_VERSION = "7"
MEDIA_TYPE = "application/waymark+json; v=7"
...
__all__ = [
    ...
    "Deny", "Derived", "DraftPolicy", "Edit", "Effect", "Guard", "Inputs",
    "Member",
    "Never",
    "On", "OneOf", "Owns",
...
def __getattr__(name: str):
    ...
    # waymark7` stays light for definition-only consumers (e.g. the CLI check).
