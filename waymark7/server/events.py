...
log = logging.getLogger("waymark7.events")

OBSERVATION_CHANNEL = "waymark7_observations"
DERIVATION_CHANNEL = "waymark7_derivations"
...
class Dispatcher:
    ...
    async def start(self) -> None:
        ...
        self._task = asyncio.create_task(self._run(), name="waymark7-dispatcher")
