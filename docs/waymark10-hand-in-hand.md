...
| 2 Company | presence surface, viewing dots, Follow on member pages, presence-steered follow, concealment-projected; **landed 2026-07-15:** the read door — a grant-scoped GET marks gaze itself (source `read`, under a leash means watchable), full-URL selves normalize, and the follow chip shows live gaze / last-seen / parked-on-Access instead of silence | — (landed; needs the story's polish pass) |
