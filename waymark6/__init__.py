...
or an event class (design: docs/waymark6-design.md)."""
...
FORMAT_VERSION = "6"
MEDIA_TYPE = "application/waymark+json; v=6"
...
__all__ = [
    ...
    "Deny", "Derived", "DraftPolicy", "Edit", "Effect", "Guard", "Member",
    "Never",
    "On", "OneOf", "Owns",
...
def __getattr__(name: str):
    ...
    # waymark6` stays light for definition-only consumers (e.g. the CLI check).
