...
log = logging.getLogger("waymark6.events")

OBSERVATION_CHANNEL = "waymark6_observations"
DERIVATION_CHANNEL = "waymark6_derivations"
...
class Dispatcher:
    ...
    async def start(self) -> None:
        ...
        self._task = asyncio.create_task(self._run(), name="waymark6-dispatcher")
