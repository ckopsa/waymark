...
accepted frames publish on ``waymark2_collab``, every worker's rooms
...
from .drafts import COLLAB_CHANNEL, PROTOCOL, SHARED, audience_of

__all__ = ["PROTOCOL", "SHARED", "CollabRooms", "serve", "actor_of"]
